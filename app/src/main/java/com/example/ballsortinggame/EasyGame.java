...
public class EasyGame extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridLayout = findViewById(R.id.easyGrid);
    ...
    private void placeSelectedElement(int col, int emptyRow) {
        ...
        Button targetButton = (Button) gridLayout.getChildAt((emptyRow * 5) + col);
    ...
    private void selectNonEmptyElement(int col, int row) {
        ...
        // change the original spots color with empty
        button.setBackgroundTintList(ColorStateList.valueOf(getEmptyColor()));
    ...
    private Button getButton(int row, int col) {
        return (Button) gridLayout.getChildAt((row * 5) + col);
    }
